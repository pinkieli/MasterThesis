...
\end{bmatrix}
\end{equation}
关于Runge-Kutta方法更加详细的分析和应用可以参考文献或专著\inlinecite{Butcher2016a,Lapidus1971,ErnstHairer1993a,ErnstHairer1996a,LiShouFo2010a,Lambert1973,Butcher1987}。
...
零稳定性在一些文献\inlinecite{Denholm1973a,Stetter1973a}中也称为D\textbf{稳定性}，仅仅是“Dahlquist-stability”的简称。在本文中一律使用零稳定性。
...
\end{equation}
称为线性多步法(\ref{eq:ch2lms})的特征多项式，其定义与经典线性多步法理论框架\cite{LiShouFo2010a,Butcher2016a,Gear1971c,ErnstHairer1993a,ErnstHairer1996a,Butcher1987,Fatunla1988a,YuanZhaoDing1987a}下推导的结果是一致。
...
Runge-Kutta方法(\ref{eq:ch2RK})是BN稳定的\cite{Butcher1975,Fatunla1988a}，如果针对满足条件(\ref{eq:ch2OndsideLipsc})的非自治微分方程(\ref{eq:ch2testfunBNstable})的数值解$y_n,\tilde{y}_n$，有
\begin{equation}
||y_{n+1}-\tilde{y}_{n+1}||\le||y_n-\tilde{y}_n||
\end{equation}成立。
\end{definition}
